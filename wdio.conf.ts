...
export const config: WebdriverIO.Config = {
    ...
    capabilities: [{
        ...
        //         `--user-data-dir=${path.resolve('C:/Users/Super/AppData/Local/Microsoft/Edge/User Data')}`,
        //         // Profile name (e.g., "Default", "Profile 1", etc.)
    ...
    framework: 'cucumber',
    cucumberOpts: {
        require: ['./tests/**/*.step.ts'],        // <string[]> (file/dir) require files before executing features
